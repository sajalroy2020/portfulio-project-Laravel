...
<main>
    <div class="container-fluid">
        ...
        <div class="col-md-6 mx-auto">
            ...
            @endif 
            <form class="user" action="{{ url('admin/works/design/development_store') }}" method="POST" enctype="multipart/form-data">
                @csrf                
                <div class="form-group">
                    ...
                    @enderror  
                    <input name="work_development_title" type="text" class="form-control py-4" id="exampleInputPassword">
                </div>
                ...
                <div class="form-group">
                    ...
                    @error('work_development_sub_title')
                        <span class="alert alert-danger">{{$message}}</span>
                    @enderror  
                    <input name="work_development_sub_title" type="text" class="form-control py-4" id="exampleInputPassword">
                </div>

                <div class="form-group">
                    <label class="text-dark"><b>Image</b></label>
                <div class="mb-3">
                    @error('development_img')
                        <span class="alert alert-danger">{{$message}}</span>
                    @enderror 
                </div>
